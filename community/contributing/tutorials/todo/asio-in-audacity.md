...
{% hint style="info" %}
ASIO recently got open sourced. It will be natively supported in a future version. In the meantime, a version of Audacity 3.7.5 with ASIO enabled can be downloaded here: [https://github.com/LeoWattenberg/audacity/releases/tag/asio](https://github.com/LeoWattenberg/audacity/releases/tag/asio)
{% endhint %}
...
[https://manual.audacityteam.org/man/asio\_audio\_interface.html](https://manual.audacityteam.org/man/asio_audio_interface.html)
